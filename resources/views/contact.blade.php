<x-base>
    ...
    <div class="relative">
        ...
        <div class="relative h-[500px]">
            <img src="{{ asset('img/contact_wp.jpg') }}" alt="Background Image" class="absolute w-full h-full object-cover">
            ...
            <div class="bg-neutral shadow-lg rounded-lg p-8 max-w-md w-full">
                <form>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="input input-bordered w-full" type="text" id="name" placeholder="Tu nombre" required>
                    </div>
                    <!-- Campo Email -->
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="email">Email</label>
                        <input class="input input-bordered w-full" type="email" id="email" placeholder="Tu email" required>
                    </div>
                    <!-- Campo Asunto -->
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="subject">Asunto</label>
                        <input class="input input-bordered w-full" type="text" id="subject" placeholder="Asunto" required>
                    </div>
                    <!-- Campo Mensaje -->
                    <div class="mb-6">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="message">Mensaje</label>
                        <textarea class="textarea textarea-bordered w-full" id="message" placeholder="Tu mensaje" rows="5" required></textarea>
                    </div>
                    <!-- Botón de envío -->
                    <div class="flex justify-center">
                        <button class="btn btn-primary w-full" style="background-color: #f1cad0; color: white;">Enviar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="bg-primary bg-opacity-20 flex flex-row justify-around pb-10 text-center">
        <div class="flex flex-col items-center mb-5 w-3/12">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-20">
        ...
        <div class="flex flex-col items-center mb-5 w-3/12">
            ...
            <p>¿Requieres de una atención más directa? comunícate con nosotros al 442 192 1400 y te contestamos cuanto antes</p>
        </div>
        <div class="flex flex-col items-center mb-5 w-3/12">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-20">
            ...
            <p>¿Ocurrió alguna situación con un vendedor o un comprado? Responde nuestro formulario de contacto y lo solucionamos</p>
        </div>
    </div>
</x-base>
